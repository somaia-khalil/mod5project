...
{/* <!-- Top Display Sub-Categories (Only display if there are further subcategories) --> */}
    ...
    {category.categories.map((category)=> <li><Link to={`/stores/${props.match.params.id}/categories/${category.id}`}><img src="http://prestashop.templatemela.com/PRS05/PRS050107/img/c/8-medium_default.jpg" width="90" height="90"/><h5>{category.name}</h5></Link></li>)}
